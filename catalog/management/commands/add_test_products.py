...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        products = [
            ...
            {
                "name": "BMW",
                "description": "Автомобиль из баварии>",
                "image": "",
                "category": category3,
            ...
            {
                "name": "AUDI",
                "description": " Автомобиль из германии",
                "image": "",
                "category": category3,
        ...
        for product in products:
            ...
            if created:
                self.stdout.write(
                    self.style.SUCCESS(f"Товар {product.name} успешно добавлен в базу!")
                )
            else:
                self.stdout.write(
                    self.style.WARNING(
                        f"Выбранные товары {product.name} уже имеется в базе!"
                    )
                )
